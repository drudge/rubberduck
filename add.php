<?php
    ...
    {
        header('Location: login.php?caller=add.php');
    }
    elseif(isset($_POST['add_sub']))
    {
        ...
        if($ret === true)
        {
            $GLOBALS['db']->add_todo_item($_POST['level_nr'],$_POST['short'], $_POST['long']);
            ?>
    ...
    else
    {
        ...
        <html>
        <head>
            <title>Rubberduck :: Add a TODO Item</title>
            <link href="styles.css" rel="stylesheet" type="text/css">
        </head>
        ...
        <table width="100%" cellspacing="4" cellpadding="0">
            <tr>
            <td align="left" height="40" valign="top"><b>Add your TODO Item</b></td>
        ...
        <tr>
            ...
            <td>
                <input type="text" length=255 size=39 name="short">
            </td>
        </tr>
        <tr>
            <td>Long description</td>
            <td>
                <textarea cols="29" rows="4" name="long"></textarea>
            </td>
        </tr>

        <tr>
            <td colspan="2" height="50" valign="middle" align="right">
                <input type="submit" name="add_sub" value="Add to TODO List">
            </td>
        </tr>
        </table>
